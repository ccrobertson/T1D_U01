...
RESULTS = join(BASE_DIR, "ldsc_maf0.01_allSNPs_summits" + EXT)
...
rule get_snp_list:
    """
    Make input snplist files for LDSC and munge_sumstats
    Only use SNPs (no indels) with rsIDs
    """
    input:
        T1D2021
    output:
        ldsc = "data/2020_chiou_t1d_gwas/2021_nature/ldsc.snplist",
        munge = "data/2020_chiou_t1d_gwas/2021_nature/munge.snplist",
    shell:
        """
        python scripts/prep_chiou_2021_get_snplists.py
        """
