...
library(data.table)
genoDF = fread("results/multiome/demultiplex/souporcell_clusters_and_donors_filtered.raw", header=TRUE)
...
pdf(file.path(opts$outdir,"corrplot_kinship_heatmap.pdf"), width=12, height=12)
heatmap(kinMat)
...
pdf(file.path(opts$outdir,"corrplot_r_heatmap.pdf"), width=12, height=12)
